...
# Define paths - UPDATE THESE FOR YOUR NAMETHISGAME DATA
data_folder = "161_RZ_9170137_Feb-20-17-43-36"  # Folder containing frame images
txt_file = "161_RZ_9170137_Feb-20-17-43-36.txt"  # Your data file
...
# Action mapping for NameThisGame
ACTION_NAMES = {
    0: "NOOP",
    1: "FIRE",
    2: "RIGHT",
...
for idx, row in df.iterrows():
    ...
    if gaze_points is not None and len(gaze_points) > 0:
        ...
        color = 'orange' if use_previous else 'cyan'  # Changed to cyan for underwater theme
    ...
    title = f"NameThisGame - Frame {frame_id} | Score: {score} | Duration: {duration}ms | Action: {action_name} | Gaze Points: {gaze_count}{status}"
