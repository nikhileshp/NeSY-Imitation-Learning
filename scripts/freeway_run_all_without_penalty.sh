...
echo "=================================================="
echo "Training/Testing pipeline for Freeway"
echo "=================================================="
...
MODEL_BASE_PREFIX="rdn_models/freeway/all/negpos_${NEG_POS_RATIO}_trees_${NUM_TREES}_depth_${MAX_DEPTH}"
...
# Freeway actions to train/test (only 3 actions)
